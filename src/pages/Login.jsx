...
const LoginPage = () => {
  return (
    ...
    <div class="max-w-lg px-5 py-16 md:px-10 md:py-24 lg:py-32">
        <div class="mb-6 ml-2 flex h-14 w-auto items-center justify-center">
          <img src={Logo} alt="" class="inline-block" />
        </div>
    </div>
    </div>
    <div class="flex flex-col items-center justify-center bg-[#FFE167]">
    <div class="max-w-lg px-5 py-16 md:px-10 md:py-24 lg:py-32">
    <h1 class="mb-8 text-3xl font-bold md:mb-12 md:text-5xl text-white">Login</h1>
    <form class="mx-auto mb-4 max-w-sm pb-4" name="wf-form-password" method="get">
    ...
    <div class="relative">
       <img alt="" src="https://assets.website-files.com/6357722e2a5f19121d37f84d/6357722e2a5f190b7e37f878_EnvelopeSimple.svg" class="absolute bottom-0 left-[5%] right-auto top-[26%] inline-block" />
          <input type="email" class="mb-4 block h-9 w-full border border-black bg-[#f2f2f7] px-3 py-6 pl-14 text-sm text-[#333333]" maxlength="256" name="name" placeholder="" required="" />
      </div>
      ...
      <div class="relative mb-4">
            ...
            <input type="password" class="mb-4 block h-9 w-full border border-black bg-[#f2f2f7] px-3 py-6 pl-14 text-sm text-[#333333]" placeholder="" required="" />
          </div>
          <a href="#" class="flex items-center justify-center bg-[#f18c27] px-8 py-4 text-center font-semibold text-white transition">
            <p class="w-3xl mr-6 font-bold">Login</p>
